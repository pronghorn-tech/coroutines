...
public sealed class CoroutinePromiseMultiWaiter<T> {
...
internal class ExternalPromiseMultiWaiter<T>(val worker: CoroutineWorker,
                                             private val future: CoroutineFutureMultiWaiter<T>) : CoroutinePromiseMultiWaiter<T>() {
...
internal class InternalPromiseMultiWaiter<T>(private val future: CoroutineFutureMultiWaiter<T>) : CoroutinePromiseMultiWaiter<T>() {
